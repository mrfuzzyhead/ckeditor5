...
describe( 'DomConverter – whitespace handling – integration', () => {
	...
	describe( 'normalizing whitespaces around block boundaries (#822)', () => {
		...
		it( 'white space before empty inline element is not ignored', () => {
		...
		it( 'white space after empty inline element is not ignored', () => {
		...
		it( 'white spaces around empty inline element are not ignored', () => {
